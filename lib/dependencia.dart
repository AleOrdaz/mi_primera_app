...
class Dependencia extends StatefulWidget {
  const Dependencia({super.key});

  @override
  State<Dependencia> createState() => _DependenciaState();
}
...
class _DependenciaState extends State<Dependencia> {
  int? rating;
